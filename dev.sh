...
push_docker() {
    ...
    docker tag blob-store europe-central2-docker.pkg.dev/blobs-project-449409/repo/blob-store:latest && \
    docker push europe-central2-docker.pkg.dev/blobs-project-449409/repo/blob-store:latest || {
